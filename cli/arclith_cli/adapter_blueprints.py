...
_ROLE_GUIDANCE = {
    ...
    "features": "One public transport feature per package. Create it through expose-usecase or expose-feature, never by inference.",
...
def render_adapter_blueprint(
    ...
    *,
    ...
    result["README.md"] = (
        ...
        "Business features are exposed only with `arclith-cli expose-usecase` "
        "or `arclith-cli expose-feature`.\n\n"
...
def _empty_binding_registry(capability: str) -> str:
    ...
    return (
        ...
        '    """No public operation is exposed until a binding command is run."""\n'
    )
